...
Decision for issue [#3](https://github.com/tidy-dev-team/tidy-ds-toolbox-documentation/issues/3).
Part of map [#1](https://github.com/tidy-dev-team/tidy-ds-toolbox-documentation/issues/1).
Date of the prototype: 20 August 2026.

The research in [#2](https://github.com/tidy-dev-team/tidy-ds-toolbox-documentation/issues/2) gathered facts and made no recommendation.
...
The page is the Tidy Doc module page, with the nine-section anatomy fixed in [#4](https://github.com/tidy-dev-team/tidy-ds-toolbox-documentation/issues/4), real Simplified Technical English prose, a real step list, and a real screenshot of the Tidy Doc panel.
...
The page itself is committed as `notes/tidy-doc-page-draft.md`, because the writing ticket needs it.
...
Docusaurus carries a React and webpack floor, measured in [#2](https://github.com/tidy-dev-team/tidy-ds-toolbox-documentation/issues/2) at 1275 lockfile entries.
...
Both-theme screenshots are not a requirement yet, and [#7](https://github.com/tidy-dev-team/tidy-ds-toolbox-documentation/issues/7) has not decided whether they ever will be.
...
`notes/images/panel-shell.png` and `notes/images/tidy-doc-panel.png` were both captured this way.
...
[#4](https://github.com/tidy-dev-team/tidy-ds-toolbox-documentation/issues/4) decided the site's navigation follows panel order, so that decision means grouped by maturity, and the site must carry the same three headings.
...
Confirmed in `src/plugins/tidy-doc/ui.tsx` in the plugin repo.
So the two ways to run Tidy Doc give different results, and the module page has to say which is which.
The drafted page in [#4](https://github.com/tidy-dev-team/tidy-ds-toolbox-documentation/issues/4) was wrong on this point and is corrected in `docs/research/tidy-doc-page-draft.md`.
